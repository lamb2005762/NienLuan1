...
<template>
  <Form :validation-schema="Loginform" @submit="handleLogin">
    ...
    <div class="form-outline mb-3">
      ...
      <Field id="pwd" placeholder="Nhập mật khẩu" name="password" type="password" class="form-control form-control-lg" />
    ...
    <div class="text-center tex t-lg-start mt-4 pt-2">
      ...
      <p class="small fw-bold mt-2 pt-1 mb-0">Bạn không có tài khoản? <router-link to="/logup" class="link-danger">Đăng ký
          ngay</router-link></p>
    </div>
  </Form>
</template>